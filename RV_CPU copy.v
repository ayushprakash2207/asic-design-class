...
`include "RV_CPU_gen.v" //_\TLV
   ...
   //_|cpu
      ...
      //_@1
         ...
         assign CPU_is_i_instr_a1 = CPU_instr_a1[6:3] == 5'b0000 ||
         ...
         assign CPU_is_s_instr_a1 = CPU_instr_a1[6:3] == 5'b0100;
         ...
         // Branch Instruction
         assign CPU_is_beq_a1 = CPU_dec_bits_a1[9:0] == 10'b0001100011;
         assign CPU_is_bne_a1 = CPU_dec_bits_a1[9:0] == 10'b0011100011;
         assign CPU_is_blt_a1 = CPU_dec_bits_a1[9:0] == 10'b1001100011;
         assign CPU_is_bge_a1 = CPU_dec_bits_a1[9:0] == 10'b1011100011;
         assign CPU_is_bltu_a1 = CPU_dec_bits_a1[9:0] == 10'b1101100011;
         assign CPU_is_bgeu_a1 = CPU_dec_bits_a1[9:0] == 10'b1111100011;
         ...
         // Jump Instruction
         assign CPU_lui_a1 = CPU_dec_bits_a1[6:0] == 7'b0110111;
         assign CPU_auipc_a1 = CPU_dec_bits_a1[6:0] == 7'b0010111;
         assign CPU_jal_a1 = CPU_dec_bits_a1[6:0] == 7'b1101111;
         assign CPU_jalr_a1 = CPU_dec_bits_a1[9:0] == 10'b000_1100111;
      ...
      //_@3
         ...
         assign CPU_result_a3[31:0] = CPU_is_addi_a3 ? CPU_src1_value_a3 + CPU_imm_a3 :
                         ...
                         CPU_jalr_a3 ? CPU_pc_a3 + 4 :
                         (CPU_is_load_a3 || CPU_is_s_instr_a3) ? CPU_src1_value_a3 + CPU_imm_a3 : 32'bx;
         
         // Register File Write
         assign CPU_rf_wr_en_a3 = CPU_valid_a3 ? (CPU_rd_a3 == 5'b0) ? 1'b0 : CPU_rd_valid_a3 : CPU_ld_data_a5;
         //_?$rf_wr_en
      ...
      //_@5   
         ...
         OUT = CPU_Xreg_value_a5[10];                
         end

         `BOGUS_USE(CPU_clk_ayu_a5)
   ...
   //  o CPU visualization
   //_|cpu
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 16   // Instantiated from Final_CPU.tlv, 265 as: m4+imem(@1)
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 31   // Instantiated from Final_CPU.tlv, 266 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 48   // Instantiated from Final_CPU.tlv, 267 as: m4+dmem(@4)
         // Data Memory
         //_@4
   ...
   //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 61   // Instantiated from Final_CPU.tlv, 268 as: m4+cpu_viz(@4)
      
      //_|cpu
         // for pulling default viz signals into CPU
         // and then back into viz
         //_@0
            assign {CPU_dummy_a0[0:0], CPU_is_auipc_a0, CPU_is_csrrc_a0, CPU_is_csrrci_a0, CPU_is_csrrs_a0, CPU_is_csrrsi_a0, CPU_is_csrrw_a0, CPU_is_csrrwi_a0, CPU_is_jal_a0, CPU_is_jalr_a0, CPU_is_lb_a0, CPU_is_lbu_a0, CPU_is_lh_a0, CPU_is_lhu_a0, CPU_is_lui_a0, CPU_is_lw_a0, CPU_is_store_a0} = {CPUVIZ_Defaults_dummy_a0, CPUVIZ_Defaults_is_auipc_a0, CPUVIZ_Defaults_is_csrrc_a0, CPUVIZ_Defaults_is_csrrci_a0, CPUVIZ_Defaults_is_csrrs_a0, CPUVIZ_Defaults_is_csrrsi_a0, CPUVIZ_Defaults_is_csrrw_a0, CPUVIZ_Defaults_is_csrrwi_a0, CPUVIZ_Defaults_is_jal_a0, CPUVIZ_Defaults_is_jalr_a0, CPUVIZ_Defaults_is_lb_a0, CPUVIZ_Defaults_is_lbu_a0, CPUVIZ_Defaults_is_lh_a0, CPUVIZ_Defaults_is_lhu_a0, CPUVIZ_Defaults_is_lui_a0, CPUVIZ_Defaults_is_lw_a0, CPUVIZ_Defaults_is_store_a0};
            `BOGUS_USE(CPU_dummy_a0)
            generate for (xreg = 0; xreg <= 31; xreg=xreg+1) begin : L1b_CPU_Xreg //_/xreg
            ...
            generate for (dmem = 0; dmem <= 15; dmem=dmem+1) begin : L1b_CPU_Dmem //_/dmem
      ...
      /*SV_plus*/
         ...
         initial begin
         instr_strs[0] = "ADD r10,r0,r0";
         instr_strs[1] = "ADD r14,r10,r0";
         instr_strs[2] = "ADDI r12,r10,1010";
         instr_strs[3] = "ADD r13,r10,r0";
         instr_strs[4] = "ADD r14,r13,r14";
         instr_strs[5] = "ADDI r13,r13,1";
         instr_strs[6] = "BLT r13,r12,1111111111000";
         instr_strs[7] = "ADD r10,r14,r0";
         instr_strs[8] = "SW r0,r10,100";
         instr_strs[9] = "LW r15,r0,100";
         instr_strs[10] = "END";
         end
         
               //_|cpuviz
         //_@1
            generate for (imem = 0; imem <= 9; imem=imem+1) begin : L1_CPUVIZ_Imem //_/imem
  ...
  // TODO: Cleanly report non-integer ranges.
         ...
         //_@0
            //_/defaults
               ...
               generate for (xreg = 0; xreg <= 31; xreg=xreg+1) begin : L1_CPUVIZ_Defaults_Xreg //_/xreg
               ...
               generate for (dmem = 0; dmem <= 15; dmem=dmem+1) begin : L1_CPUVIZ_Defaults_Dmem //_/dmem
         ...
         //_@4
            ...
            generate for (xreg = 0; xreg <= 31; xreg=xreg+1) begin : L1_CPUVIZ_Xreg //_/xreg
            ...
            generate for (dmem = 0; dmem <= 15; dmem=dmem+1) begin : L1_CPUVIZ_Dmem //_/dmem
            ...
            // Register file
            //
            generate for (xreg = 0; xreg <= 31; xreg=xreg+1) begin : L1b_CPUVIZ_Xreg //_/xreg           
               
            end endgenerate
            //
            // DMem
            //
            generate for (dmem = 0; dmem <= 15; dmem=dmem+1) begin : L1b_CPUVIZ_Dmem //_/dmem
