...
`include "RV_CPU_gen.v" //_\TLV
   ...
   //_|cpu
      ...
      //Fetch
         ...
         assign CPU_pc_a0[31:0] = (CPU_reset_a1) ? 32'd0 : 
                     ...
                     (CPU_valid_jump_a3 && CPU_jal_a3) ? CPU_br_tgt_pc_a3 :
                     (CPU_valid_jump_a3 && CPU_jalr_a3) ? CPU_jalr_tgt_pc_a3 : CPU_inc_pc_a1;
      ...
      // Decode   
         ...
         assign CPU_is_jump_a1 = CPU_jal_a1 || CPU_jalr_a1;
   ...
   //  o CPU visualization
   //_|cpu
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 16   // Instantiated from Final_CPU.tlv, 277 as: m4+imem(@1)
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 31   // Instantiated from Final_CPU.tlv, 278 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 48   // Instantiated from Final_CPU.tlv, 279 as: m4+dmem(@4)
         // Data Memory
         //_@4
